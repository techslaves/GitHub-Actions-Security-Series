...
jobs:
  leak-job:
    ...
    steps:   
      ...
      - name: Writing to GitHub repository
        run: |
          # Configure Git
...
1. Update GitHub repository setting as: Go to Repository Settings —> Click on **Actions** on left menu → Then click on **General** —> Under **Workflow permissions** select **Read and write permissions →** Click on Save
